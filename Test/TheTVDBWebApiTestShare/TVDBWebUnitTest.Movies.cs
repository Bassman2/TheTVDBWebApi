namespace TheTVDBWebApiTest
{
    public partial class TVDBWebUnitTest
    {
        ...
        public async Task TestMethodGetMovieTranslationsAsync()
        {
            ...
            Assert.IsTrue(res.IsPrimary, "IsPrimary");
        }
        ...
        public async Task TestMethodGetMovieStatusesAsync()
        {
            ...
            Assert.AreEqual(RecordType.Movie, res[0].RecordType, "RecordType0");
            ...
            Assert.AreEqual(RecordType.Movie, res[1].RecordType, "RecordType1");
            ...
            Assert.AreEqual(RecordType.Movie, res[2].RecordType, "RecordType2");

            Assert.AreEqual(4, res[3].Id, "Id3");
            Assert.IsFalse(res[3].KeepUpdated, "KeepUpdated3");
            Assert.AreEqual("Completed", res[3].Name, "Name3");
            Assert.AreEqual(RecordType.Movie, res[3].RecordType, "RecordType3");

            Assert.AreEqual(5, res[4].Id, "Id4");
            Assert.IsFalse(res[4].KeepUpdated, "KeepUpdated4");
            Assert.AreEqual("Released", res[4].Name, "Name4");
            Assert.AreEqual(RecordType.Movie, res[4].RecordType, "RecordType4");
        }
