namespace TheTVDBWebApiShare
{
    partial class TVDBWeb
    {
        ...
        public async Task<Translation> GetSeasonTranslationAsync(string id, string language, CancellationToken cancellationToken = default)
        {
            return await GetDataAsync<Translation>($"v4/season/{id}/translations/{language}", cancellationToken);
        }
    }
}
